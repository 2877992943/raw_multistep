...
from make_message import get_conversation_imgbase64_his
...
#         "loss_mask": 0
#     }
# def get_imgbase64_content(encoded_string,min_pixels=256,max_pixels=3300):
#     return {
#         "role": "user",
#         "content": [
#             {
...
class UITARSAgent:
    ...
    def predict(
        ...
        ### 用另一个方法获得 message
        messages=get_conversation_imgbase64_his(instruction,self.history_responses_limituse,encoded_string)
        #######
        # 尝试 3次 预测和解析结果
        try_times = 3
